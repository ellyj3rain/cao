...
Current version: `1.0.0.0-alpha`. Implementation is complete through batch `B2`; `B3` is the next development batch. The verified assembly is deployed for operator runtime testing. Static verification does not substitute for how the game looks and plays.
