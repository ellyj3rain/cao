...
| GitHub | `ci-verify`, `dependency-scan`, and advisory `codeql-csharp` workflows are defined with immutable action SHAs; Dependabot, CODEOWNERS, and the pull-request contract are present. Hosted execution and `main` protection are pending branch publication. |
...
Result: **LOCAL PASS / HOSTED ACTIVATION PENDING**
