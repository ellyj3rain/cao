...
|---:|---|---|---|
| 1 | Orphan regional markers are removed | **PASS** | no preview painter remains for the former A or diamond glyphs |
| 2 | Culture identity references follow their owner | **PASS** | self-constituent labels and generated local names follow the owning Culture |
| 3 | Explicit local Culture names remain independent | **PASS** | parent propagation is conditional on the local name remaining generated |
| 4 | Player copy does not expose model-working vocabulary | **PASS** | chat and model terminology remain design input; Culture and Political Order screens state choices and effects in direct player language |
| 5 | Political Order has complete causal breadth | **PASS** | 26 questions; 12 ownership domains; 110 positions; 8 complete presets |
| 6 | Mixtures and exclusive choices have explicit invariants | **PASS** | blendable questions normalize to 100; exclusive questions retain one answer |
| 7 | Generated political identity follows variables | **PASS** | name, short summary, and natural account project the configured order |
| 8 | Custom political prose remains secondary | **PASS** | optional display naming does not replace the generated causal account |
| 9 | The progressive mixed order is representable | **PASS** | executive/civic authority, public essentials, mixed industry and luxury enterprise, and anti-rent policy coexist |
| 10 | One question edit owns one direct variable | **PASS** | SetQuestion replaces only the selected question before deterministic normalization |
