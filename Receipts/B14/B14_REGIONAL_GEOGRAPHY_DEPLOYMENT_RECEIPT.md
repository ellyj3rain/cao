...
| Installed mod target | **PASS** | `Mods/ColonistAwareness` is a junction to the complete active repository checkout. Its former target, the stale parent checkout, remains present and untouched but is no longer the installed mod. |
