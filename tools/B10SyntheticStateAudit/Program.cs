...
internal static class Program
{
    ...
    private static readonly Dictionary<string, Classification> FileClasses =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ConstructionMaterialsModule.cs"] = Form("deterministic tie-break among materials already established as available to the site"),
            ["ConvergenceExerciseModule.cs"] = Technical("governed fixed-seed scaffolding for the disposable developer benchmark exercise"),
            ...
            ["FeatureShapeModule.cs"] = Form("authored feature-shape variant folded into the generation salt"),
            ["FloraLoadModule.cs"] = Form("native GenStep_Plants per-cell skip idiom preserved inside the bounded regional seed budget"),
            ...
            ["RegionalFreezeScanModule.cs"] = Technical("commentary about a stated native melt-draw divergence"),
            ...
            ["RegionalWorldSettlementModule.cs"] = Form("eligible world-settlement placement and founder selection after eligibility exists"),
            ...
            ["SettlementFitOutModule.cs"] = Technical("deterministic seeded scope for settlement interior fit-out"),
            ["SettlementProgramCausalKernel.cs"] = Receipt("program evidence signature or equivalent functional-asset selection"),
            ["SettlementSubsistenceModule.cs"] = Form("field layout, plant growth and crop-form variation inside an authored subsistence program"),
            ...
            ["WorldFrontierModule.cs"] = Form("deterministic frontier-site ordering within a region, mirroring the plan-side realization"),
