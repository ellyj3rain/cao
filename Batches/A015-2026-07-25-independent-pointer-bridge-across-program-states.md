# A15 - Independent pointer bridge across program states

| Field | Record |
|---|---|
| Batch | `A15` |
| Date | 2026-07-25 12:40 UTC / 05:40 PST |
...
Extended the event-local pointer bridge beyond Playing to menus and dialogs.
