...
| Deployment | Recorded after publication in `B11_DEPLOYMENT_RECEIPT.md`; RimWorld remains closed during replacement and the deployed DLL must be byte-identical to the verified build. |
