    ...
    public static class CAAuthoringControlContracts
    {
        public static readonly IReadOnlyList<CAAuthoringControlContract> All =
            new[]
            {
                ...
                Control("culture.social-meaning",
                    CAAuthoringSemanticKind.StructuredComposition,
                    "CACulture", "Culture constituent population",
                    CAAuthoringTemporalStatus.Normative,
                    "zero or one meaning per registered subject and population scope; many distinct pairs may coexist",
                    "different populations may interpret one subject differently; one pair has one current interpretation",
                    "player-authored initial meaning or lived interpretation",
                    new[] { "CACulturalMeaning.subjectKey",
                        "CACulturalMeaning.populationScope",
                        "CACulturalMeaning.approval",
                        "CACulturalMeaning.normality",
                        "CACulturalMeaning.prestige",
                        "CACulturalMeaning.salience" },
                    "social interpretation, legitimacy, reaction, and cultural expression"),
                Control("culture.practice",
                    ...
                    "player-authored pre-start history or longitudinal evidence adapter",
