...
| Dubs Bad Hygiene | Dubwise56 (Dubwise) | `github.com/Dubwise56/Dubs-Bad-Hygiene` | no licence stated; removable on request | n/a | art, sounds, and defs standing on vanilla machinery. **No code** — the compiled assembly is not published, so nothing could be ported | defs quarantined from live; needs re-implemented on native seams |
